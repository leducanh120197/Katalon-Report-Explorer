...
// Trang chủ
// Cập nhật CSS trong phần app.get('/')
    ...
    res.send(`
        ...
        <head>
            ...
            <style>
                ...
                .file-row:hover, .folder-row:hover {
                ...
                .toggle-folder::before {
                    content: "▶ ";
                }
                
                .open .toggle-folder::before {
                    content: "▼ ";
                }
                ...
                document.querySelectorAll('.toggle-folder').forEach(f => {
                    ...
                    if (f.getAttribute('data-has-files') === 'true') {
                        f.onclick = () => {
                            ...
                            // Sửa lỗi cú pháp ở đây - thay đổi cách sử dụng selector
